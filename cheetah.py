"""Cheetah environment, taken from mujoco-playground."""
...
class MjCheetah(mjx_env.MjxEnv):
  ...
  def __init__(
    ...
    self._xml_path = (_XML_PATH / f'cheetah-{version}.xml').as_posix()
    self._model_assets = common.get_assets()
    self._mj_model = mujoco.MjModel.from_xml_string(
        (_XML_PATH / f'cheetah-{version}.xml').read_text(), self._model_assets
    )
